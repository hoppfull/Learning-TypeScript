module App {
    export function* run(): IterableIterator<Promise<any>> {
        ...
        const screenData = Ajax.loadJSON<modelData>('res/screen.json')
        ...
        testShader.onrender = () => {
            gl.uniformMatrix4fv(testShader.ModelMatrixUniform, false, <Float32Array>mat4.translate(ModelMatrix, IdentityMatrix, [xOffsetSlider.valueAsNumber, yOffsetSlider.valueAsNumber, zOffsetSlider.valueAsNumber]))
