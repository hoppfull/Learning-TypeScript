...
(function (Engine) {
    ...
    function bufferCubeMap(gl, posY, negY, posX, negX, posZ, negZ) {
        const TBO = gl.createTexture();
    ...
    Engine.bufferCubeMap = bufferCubeMap;
    ...
    Engine.createFBOTexture = createFBOTexture;
    ...
    function useCubeMap(gl, { id, location }, TBO) {
        gl.activeTexture(gl.TEXTURE0 + id);
        gl.bindTexture(gl.TEXTURE_CUBE_MAP, TBO);
        gl.uniform1i(location, id);
    }
    Engine.useCubeMap = useCubeMap;
})(Engine || (Engine = {}));
